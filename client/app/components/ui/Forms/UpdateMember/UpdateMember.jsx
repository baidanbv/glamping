...
const UpdateMember = ({ memberId, onSuccess, token }) => {
  ...
  const onSubmit = async (data) => {
    ...
    await membersAPI.updateMemberById(updatedData, token);
    closeUpdatePopup();
    onSuccess()
  };
  ...
  return (
    <>
      <h2 className="text-3xl font-semibold mb-6 text-center">Update Member</h2>
